    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <h3>Sentinel Data Input form </h3>

                <div class="breadcrumbs">
                    <br>
                    <!--<ul class="d-flex flex-wrap align-items-center p-0 m-0">-->
                    <li>lodge real time feeds by using the form  below</li>
                    <br>
                        ...
                        <div class="modal-body" >
                            ...
                            <div class="text-fields">
                                <div class="float-input">
                                    ...
                                    <input id="disease_report" name="disease_report" placeholder="Name of Disease / Report" required="required" size="50"
                                           type="text">
                                </div>
                                <br>
                                <div class="float-input">
                                    <span><i class="fa fa-user"></i></span>
                                    <input id="noofcases" name="noofcases" placeholder="Number of Cases" required="required" size="50"
                                           type="Number">
                                </div>
                                <BR>
                                 <div class="float-input">
                                    <span><i class="fa fa-calendar"></i></span>
                                    <input id="day" name="day" placeholder="Day" required="required" size="50"
                                           type="Number">
                                </div>
                                <BR>
                                <div class="float-input">
                                    <span><i class="fa fa-building"></i></span>
                                    <input id="location" name="location" placeholder="Location" required="required" size="50"
                                           type="text">
                                </div>
                                <br>
                            
                                <div class="float-input">
                     Select Source of Data Feed <br>
                    <input type="checkbox" name="who" value="lab coats">@who <br/>
                    <input type="checkbox" name="ncdcgov" value="scrubs">@ncdcgov<br/>
                    <input type="checkbox" name="reliefweb" value="fashion">@reliefweb<br/>
                    <input type="checkbox" name="CDCgov" value="Medical devices">@CDCgov<br/>
<!--                     <input type="checkbox" name="" value="Text books">Text books<br/>
 -->            </div>
